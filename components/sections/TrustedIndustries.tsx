          ...
          <div className="mt-20 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {industries.map((industry) => {
              ...
              return (
                <Card
                  key={industry.title}
                  className="group rounded-3xl border border-slate-200 bg-white p-8 text-center transition-all duration-500 hover:-translate-y-2 hover:border-green-600 hover:shadow-2xl"
                >
                  <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-green-50 transition-colors duration-500 group-hover:bg-green-600">
                    <Icon
                      size={38}
